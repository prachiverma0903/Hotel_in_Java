...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		lblUpdateCheckStatus.setFont(new Font("Times New Roman", Font.PLAIN, 25));
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
                            try{
                                ...
                                c.s.executeUpdate("update customer set Room = '"+s2+"', Name = '"+s3+"', CheckInStatus = '"+s4+"', Deposit = '"+s5+"' where Number = '"+s1+"'");
			...
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                                ...
                                while(rs1.next()){
                                    ...
                                    txt_Date.setText(rs1.getString("CheckInStatus"));    
